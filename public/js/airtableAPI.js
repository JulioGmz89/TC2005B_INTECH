async function fetchAirtableData(id_proyecto) {
    try {
        const res = await fetch(`http://natgas-project-manager.uc.r.appspot.com/proyecto/${id_proyecto}/airtable_data`); //cambiar dirección
...
async function getTareasDB(id_proyecto, filterIT = true) {
    let data = {}
    data = await fetch(`http://natgas-project-manager.uc.r.appspot.com/proyecto/${id_proyecto}/db_data`);
...
function postUpdate(id_proyecto, userKey_proyecto, baseKey_proyecto, fields, mode) {
    ...
    fetch(`http://natgas-project-manager.uc.r.appspot.com/proyecto/${id_proyecto}/sync/update_airtable`, {
        method: 'POST',
...
function postUpdateDB(id_proyecto, rows) {
    ...
    fetch(`http://natgas-project-manager.uc.r.appspot.com/proyecto/${id_proyecto}/sync/update_db`, {
        method: 'POST',
        body: JSON.stringify(values),
        headers: {
            "Accept": "application/json,",
